    ...
    return (
        <div className='container'>
            ...
            <form onSubmit={onSubmitForm}>
                ...
                <div className="mb-3">
                    <input type="Eth Wallet" placeholder='Ethereum Wallet Address' autoComplete='off' className='form-control' id="eth_address" ref={eth_address} />
                </div>
                <div className="mb-3">
